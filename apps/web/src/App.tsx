...
function Workspace({
  ...
  return (
    <main className="workspace-shell">
      ...
      {view === "sources" && <SourcesScreen detail={detail} onFreeze={freeze} />}
...
function SourcesScreen({ detail, onFreeze }: { detail: Detail; onFreeze: () => Promise<void> }) {
