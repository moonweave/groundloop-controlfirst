...
- allowlisted deterministic evidence operations such as local peaks, extrema, deltas, monotonicity, linear fits, power-law fits, correlations, and hysteresis windows;
