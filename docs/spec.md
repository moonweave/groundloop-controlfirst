...
- allowlisted deterministic evidence operations such as band comparisons, local peaks, group comparisons, extrema, deltas, monotonicity, linear fits, power-law fits, correlations, and hysteresis windows;
