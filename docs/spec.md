...
- allowlisted deterministic evidence operations such as local peaks, group comparisons, extrema, deltas, monotonicity, linear fits, power-law fits, correlations, and hysteresis windows;
